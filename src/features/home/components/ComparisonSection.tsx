    ...
    <section className="py-20 md:py-28">
      <div className="container mx-auto px-6">
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <p className="text-lg text-gray-600">See the difference for yourself</p>
        </div>
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-4 text-center text-sm font-semibold text-blue-600">CipherOnce</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200">
              {[
                ...
                return (
                  <tr key={featureName}>
                    <td className="px-6 py-4 text-sm text-gray-900">{featureName}</td>
                    <td className="px-6 py-4 text-center">
                      {email ? (
                        <CheckCircle2 className="mx-auto h-5 w-5 text-green-600" />
                      ) : (
                        <div className="mx-auto h-5 w-5 rounded-full bg-gray-200"></div>
                      )}
                    </td>
                    <td className="px-6 py-4 text-center">
                      {cipher ? (
